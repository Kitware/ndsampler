...
Notes:
    ...
    cd ~/code/ndsampler/docs
    sphinx-apidoc --private -f -o ~/code/ndsampler/docs/source ~/code/ndsampler/ndsampler --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/ndsampler/advanced/
        ...
        Click import project: (for github you can select, but gitlab you need to import manually)
            Set the Repository NAME: ndsampler
            Set the Repository URL: https://gitlab.kitware.com/computer-vision/ndsampler

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/ndsampler/integrations/create/
        ...
        Then go to
            ...
            https://gitlab.kitware.com/computer-vision/ndsampler/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/ndsampler/versions/
"""
#
...
modpath = join(dirname(dirname(dirname(__file__))), 'ndsampler', '__init__.py')
...
# html_logo = '.static/ndsampler.svg'
# html_favicon = '.static/ndsampler.ico'
...
latex_documents = [
    (master_doc, 'ndsampler.tex', 'ndsampler Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndsampler', 'ndsampler Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndsampler', 'ndsampler Documentation',
     author, 'ndsampler', 'One line description of project.',
     'Miscellaneous'),
]
