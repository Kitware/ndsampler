...
is used for maintaining flat or hierarchical category information.
...
TODO:
    ...
    - [X] I think its ok to keep the decision function here. Yes, but separate
          into a mixin.

    - [X] Should we not use an implicit root by default? No.
"""
...
class CategoryTree(ub.NiceRepr, Mixin_CategoryTree_Torch):
    """
    ...
    Example:
        ...
        >>> import ndsampler
        >>> ndsampler.CategoryTree.coerce(['a', 'b', 'c'])
        <CategoryTree(nNodes=3, nodes=['a', 'b', 'c']) ...
        >>> ndsampler.CategoryTree.coerce(4)
